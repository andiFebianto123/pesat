...
class ProjectMaster extends Model
{
    ...
    */
    ...
    {
        return '<a class="btn btn-sm btn-link" href="'.url('admin/project-master-detail/'.$this->project_id.'/image').'" id="'.$this->child_id.'" "><i class="la la-file-photo-o"></i> Detail Image</a>';
    }
}
