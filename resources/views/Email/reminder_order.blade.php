...
<div style="padding: 32px">
    ...
    <p></p>
    @if ($lastReminder)
    Ini adalah pengingat terakhir untuk pembayaran donasi anak di Pesat. Harap melakukan pembayaran maksimal tanggal <strong>{{Carbon\Carbon::parse($orderDetails->first()->start_order_date)->addDays(2)->format('F d, Y')}}</strong>.
    <p style="margin: 0px"></p>
