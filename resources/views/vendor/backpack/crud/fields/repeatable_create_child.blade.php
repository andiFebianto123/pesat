...
<div class="container-repeatable-elements">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="m-1 p-2" data-repeatable-identifier="addchild">
        <div class="controls">

            <div class="form-group">
                <label for="recipient-name" class="col-form-label">Nama Anak:</label>
                <select style="width:100% !important" class="form-control" id = "child" name = "child_id">
...
@if ($crud->fieldTypeNotLoaded($field))
  ...
  @push('crud_fields_scripts')
      <script>
        ...
        function addChildDonation(container, field_group_clone){
